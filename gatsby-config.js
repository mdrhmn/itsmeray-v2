...
module.exports = {
  ...
  siteMetadata: {
    ...
    author: {
      name: `Muhd Rahiman`,
      intro: `Hi, I am Muhd Rahiman, a Software Engineer from 🇲🇾`,
      url: `https://itsmeray.com/`,
      email: `mdrhmn99@gmail.com`
    },
    social: [
      {name: `GitHub`, socialUrl: `https://github.com/mdrhmn`},
      {
        name: `LinkedIn`,
        socialUrl: `https://www.linkedin.com/in/muhd-rahiman/`
      },
      {name: `Hashnode`, socialUrl: `https://ray.hashnode.dev/`},
      {name: `Dev.to`, socialUrl: `https://dev.to/mdrhmn`},
      {name: `Twitter`, socialUrl: `https://twitter.com/MuhdRahiman_`}
    ]
  },
  plugins: [
    {
